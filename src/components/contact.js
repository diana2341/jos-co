...
export default class Contact extends React.Component{
    ...
    handleSubmit= (e)=>{
      ...
      this.sendFeedback(templateId, {message_html: this.state.feedback, from_name: this.state.name, reply_to: this.state.email,from_town:this.state.town})
      console.log('sent')
        ...
        <Container>
            <Form id='form'onSubmit={this.handleSubmit}>
                <Form.Group  as={Row} controlId="Name">
                    ...
                    <Form.Control onChange={this.handleChange}name='name'type="Name" placeholder="Name"value={this.state.name}/>
                </Form.Group>
                ...
                <Form.Group  as={Row} controlId="exampleForm.ControlTextarea1">
                    ...
                    <Form.Control onChange={this.handleChange}name='feedback'type="Message"value={this.state.feedback} placeholder="Message"  as="textarea" rows={3} />
                </Form.Group>
